class Maze:
    ...
    def __init__(self, im):
        ...
        for y in range(1, height - 1):
            # print ("row", str(y)) # Uncomment to keep a track of row progress
            ...
            for x in range(1, width - 1):
                ...
                # If node is not none, we can assume
                # we can connect N-S somewhere.
                if n is not None:
                    ...
                    # If clear below, put this new node
                    # in the top row for the next connection.
